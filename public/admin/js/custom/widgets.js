...
var KTWidgets = function () {
    ...
    var initMixedWidget5 = function () {
        ...
        let seens=document.querySelectorAll(".seens");
        let seen_arr=Array();
        seens.forEach(seen=>{
                let seen_val=seen.innerHTML;
                seen_arr.push(seen_val);

        });
        console.log(seen_arr);
        ...
        [].slice.call(charts).map(function (element) {
            ...
            var options = {
                series: [{
                    name: 'تعداد ',
                    data: [seen_arr[0], seen_arr[1],seen_arr[2],seen_arr[3],seen_arr[4],seen_arr[5],seen_arr[6]]
                }],
                chart: {
                    fontFamily: 'inherit',
                    type: 'area',
                ...
                xaxis: {
                    categories: ['شنبه', 'یک شنبه', 'دوشنبه', 'سه شنبه', 'چهار شنبه', 'پنج شنبه', 'جمعه'],
                    axisBorder: {
                        show: false,
                    },
                    axisTicks: {
    ...
    var initMixedWidget12 = function () {
        ...
        let lens = Array();
        let items = document.querySelectorAll(".lens");
        items.forEach(item => {
        ...
        [].slice.call(charts).map(function (element) {
            ...
            var options = {
                series: [{
                    name: '  تعداد   ',
                    data: [lens[0],lens[1],lens[2],lens[3]]
                }],
                chart: {
                    fontFamily: 'inherit',
                    type: 'bar',
                ...
                xaxis: {
                    categories: [' تعداد کل کاربران', 'تعداد پیام ها', 'تعداد دکتر ها', 'تعداد ادمین ها'],
                    axisBorder: {
                        show: false,
                    },
                    axisTicks: {
