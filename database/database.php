...
public function create($table,$fields,$values){
    try{
        $query="insert into $table (".implode(", ",$fields).', `created_at`) values (:'.
            implode(", :",$fields).",now());";
...
public function update($table,$fields,$values,$where=null,$id=null,$updated_field=' created_at'){
    try {
