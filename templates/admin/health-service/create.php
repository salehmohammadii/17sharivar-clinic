<div class="tblBox w-100 h-100 overflow-auto ps-5 pe-5">
    <form action="<?= url('admin/health-service/store/') ?>" method="post" class="mb-3 mb-lg-5 p-10" enctype="multipart/form-data">
        <h2>ویرایش</h2>
        <div class="inputBox w-100">
            <label class="d-block mt-5">عنوان خدمات</label>
            <input type="text" name="title" class="w-100 form-control mt-1" value="" placeholder="لطفا عنوان خدمات  را وارد کنید" />
