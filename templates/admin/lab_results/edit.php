...
<div class="tblBox w-100 h-100 overflow-auto ps-5 pe-5">
    ...
    url('admin/lab-result/update/'.$parametrs['id']) ?>" class="mb-3 mb-lg-5 p-10" enctype="multipart/form-data">
        <h2>اپلود نتیجه آزمایش</h2>
        <div class="inputBox w-100">
            <label class="d-block mt-5">نام و نام  خانوادگی بیمار</label>
            <input type="text" name="name" class="w-100 form-control mt-1" value="<?php /** @var array $parametrs */
            echo $parametrs['name'];  ?>" placeholder="لطفا نام و نام خانوادگی بیمار را وارد کنید" />
            <label class="d-block mt-5">نام و نام  خانوادگی دکتر معالج</label>
            <input type="text" name="doctor" class="w-100 form-control mt-1" value="<?php  echo $parametrs['doctor'];  ?>"  placeholder="لطفا نام و نام خانوادگی دکتر معالج را وارد کنید" />
            <label class="d-block mt-5">  کد آزمایش </label>
            <input type="text" name="code" class="w-100 form-control mt-1" value="<?php echo $parametrs['code'];  ?>"  placeholder="لطفا  کد آزمایش  را وارد کنید" />
            ...
            <div class=" d-flex align-items-center justify-content-end">
                    <button  class="btn btn-success mt-5" style="margin-right:auto;" type="submit"> ویرایش نتیجه</button>
            </div>
        </div>
    </form>
