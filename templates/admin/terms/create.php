<form method="post" action="<?= url('admin/terms/store') ?>" enctype="multipart/form-data" class="mb-3 mb-lg-5 p-10">
    <div class="inputBox w-100">
        <label class="d-block mt-15">  انتخاب بخش  </label>
        <select name="type" class="w-100 form-control mt-1">
            <option selected value="1" >بخش قوانین و مقررات</option>
            <option value="2">بخش قوانین حریم خصوصی</option>
        </select>
    </div>
    <div class="inputBox w-100">
        <label class="d-block mt-15">اضافه کردن قوانین جدید </label>
        <textarea name="content" class="w-100 form-control mt-5 editor"></textarea>
    </div>
