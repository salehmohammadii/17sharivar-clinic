<div class="tblBox w-100 h-100 overflow-auto ps-5 pe-5">
    <div class="card-body py-3">
        <a class=" text-white  btn-success px-3 py-2 w-100px d-block ms-auto text-center me-5" style="border-radius: 5px;" href="<?= url('admin/paraclinic/create') ?>">افزودن  </a>
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                    ...
                    <?php foreach ($parametrs as $key => $para_part) {
                        ...
                        <tr class=" text-center">
                            ...
                            <td>
                                <a class="btn-danger py-1 px-4 text-white" href="<?=url("admin/paraclinic/delete/".$para_part['id']) ; ?>">حذف</a>
                                <a class="btn-primary py-1 px-4 text-white" href="<?= url('admin/paraclinic/edit/'.$para_part['id']) ; ?>">ویرایش</a>
                            </td>
                        </tr>
                        <?php
