<div class="tblBox w-100 h-100 overflow-auto ps-5 pe-5">
    <form action="<?= url('admin/paraclinic/store/') ?>" method="post" class="mb-3 mb-lg-5 p-10" enctype="multipart/form-data">
        <h2>ویرایش</h2>
        <div class="inputBox w-100">
            <label class="d-block mt-5">عنوان بخش</label>
            <input type="text" name="title" class="w-100 form-control mt-1" value="" placeholder="لطفا عنوان بخش  را وارد کنید" />
            ...
            <label class="d-block mt-5">عکس صفحه پاراکلینیک</label>
