<div class="tblBox w-100 h-100 overflow-auto ps-5 pe-5">
    <form method="post" action="<?= url('admin/doctor/store') ?>" class="mb-3 mb-lg-5 p-10" enctype="multipart/form-data">
        <h2>ایجاد دکتر جدید</h2>
        <div class="inputBox w-100">
            <label class="d-block mt-5"> نام و نام خانوادگی دکتر </label>
            <input type="text" name="full_name" class="w-100 form-control mt-1" value="" placeholder="لطفا نام و نام خانوادگی کاربر را وارد کنید" />
            ...
            <input type="text" name="address" class="w-100 form-control mt-1" value="" placeholder="لطفا  ادرس کاربر را وارد کنید" />
            <label class="d-block mt-5">کد پرسنلی</label>
            <input type="text" name="personalCode" class="w-100 form-control mt-1" value="" placeholder="لطفا  کد پرسنلی کاربر را وارد کنید" />
            <label class="d-block mt-5">ساعت حضور</label>
            <input type="text" name="online_time" class="w-100 form-control mt-1" value="" placeholder="لطفا  کد پرسنلی کاربر را وارد کنید" />
            <label class="d-block mt-5"> پسورد حساب کاربری (برای ساخت پسورد سیستمی این فیلد را خالی رد کنید)</label>
            <input type="password" autocomplete="off" name="password" value="" class="w-100 form-control mt-1" placeholder="لطفا پسورد کاربر را وارد کنید" />
            ...
            <select name="skill" class="w-100 form-control mt-1">
                ...
                foreach($parametrs as $skills_Li) { ?>
            ...
            <textarea dir="rtl" name="resume" class="editor" id="editor"></textarea>
            <div class=" d-flex align-items-center justify-content-end">
                    <button name="new-doctor" class="btn btn-success mt-5" style="margin-right:auto;" type="submit">اضافه کردن دکتر</button>
            </div>
        </div>
    </form>
</div>
